# -*- coding: utf-8 -*-
# Generated by Django 1.9.8 on 2018-05-18 21:34
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('action', models.CharField(choices=[('activate_index', 'activate_index'), ('drop_index', 'drop_index'), ('update_index', 'update_index'), ('create_index', 'create_index')], max_length=64)),
